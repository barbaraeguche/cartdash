...
export default function EditGrocery({ item, onSave }: {
	...
	return (
		<div className="flex items-center rounded-md border-t border-b">
			<Input value={value}
			...
			<button className="rounded-md p-2 mx-auto text-green-700 hover:bg-green-100 transition-colors"
			        onClick={() => {
